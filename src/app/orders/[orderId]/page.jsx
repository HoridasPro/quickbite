...
export default function OrderTrackingPage() {
  ...
  if (loading || status === "loading") {
    return <div className="min-h-screen flex items-center justify-center text-gray-500">{t("connectingLiveTracker")}</div>;
  }

  if (!order) {
    return <div className="min-h-screen flex items-center justify-center text-red-500">{t("orderNotFoundAccessDenied")}</div>;
  }
    ...
    <div className="min-h-screen bg-[#f7f7f7] py-8 px-4">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">{t("orderLabel")} {order.orderId}</h1>
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 pb-16 md:pb-20">
          <div className="mb-6 flex items-center justify-between">
            <h2 className="font-bold text-gray-800 text-lg">{t("liveStatusHeader")}</h2>
        ...
        {order.riderName && (
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4">
            ...
            <div>
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">{t("yourRiderLabel")}</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 border-b border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">{t("pickupHeader")}</p>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-xs font-bold text-orange-500 uppercase tracking-wider mb-1">{t("deliveryHeader")}</p>
          ...
          <div className="p-6 bg-gray-50/50">
            <h3 className="font-bold text-gray-800 mb-4">{t("itemsHeader")}</h3>
              ...
              {order.items.map((item, idx) => (
                <div key={idx} className="flex justify-between items-start">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{(isBn && item.titleBn) ? item.titleBn : item.title}</p>
                    </div>
                  </div>
