...
const QuickMartPage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen overflow-hidden bg-white font-sans text-gray-800 shadow-lg relative">

      {/* --- 1. Left Sidebar --- */}
      <aside
        className={`
        fixed inset-y-0 left-0 z-50 w-64 bg-white p-5 border-r transition-transform duration-300 lg:relative lg:translate-x-0
      ...
      {/* --- 2. Main Content Area --- */}
      <main className="flex-1 h-screen overflow-y-auto p-4 md:p-6 bg-gray-50/30 custom-scrollbar shadow-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="md:flex rounded-2xl bg-gradient-to-r from-red-100 to-orange-200 p-6 items-center shadow-sm relative overflow-hidden">
            <div className="z-10">
      ...
      <aside
        ...
        h-[40vh] lg:h-screen rounded-t-3xl lg:rounded-none
      `}
      >
